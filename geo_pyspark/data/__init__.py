...
csv_polygon1_inputLocation = create_data_path("equalitycheckfiles/testequals_envelope1.csv")
csv_polygon2_inputLocation = create_data_path("equalitycheckfiles/testequals_envelope2.csv")
