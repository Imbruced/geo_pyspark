...
htmlhelp_basename = 'geo_pysparkdoc'
...
latex_documents = [
    (master_doc, 'geo_pyspark.tex', 'geo\\_pyspark Documentation',
     'Pawel Kocinski', 'manual'),
]
...
man_pages = [
    (master_doc, 'geo_pyspark', 'geo_pyspark Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'geo_pyspark', 'geo_pyspark Documentation',
     author, 'geo_pyspark', 'One line description of project.',
     'Miscellaneous'),
]
...
ddidier_sphinxdoc_image_tag = 'bc367d52f91126e4ebf63fdb25cce6930ba670c82d20283b758d931568c1748e'
